...
- [Zusammenfassung Betriebssysteme](#zusammenfassung-betriebssysteme)
  - [Einführung](#einf%C3%BChrung)
    ...
    - [Unterbrechungen (_Interrupts_)](#unterbrechungen-_interrupts_)
  - [Prozesse](#prozesse)
  ...
  - [Kommunikation zwischen Prozessen](#kommunikation-zwischen-prozessen)
    ...
    - [Bedingungen für den gegenseitigen Ausschluss (_mutual exclusion_)](#bedingungen-f%C3%BCr-den-gegenseitigen-ausschluss-_mutual-exclusion_)
    ...
    - [Verklemmungen (_Deadlocks_)](#verklemmungen-_deadlocks_)
